 ...
 * The values are represented as one map of vertices pointing to a list of edges
 * which holds the outgoing edges.
 * 
...
public class GraphHandler {
    ...
    /**
     * The UTF8_Bom - some utf8 files put this at the beginning to identify utf8
     * encoding
     */
     ...
     * 
     * @throws IOException if a vertex is used that has not been initialized by
     *                     scannVertices
     */
    ...
    /**
     * Adds an edge to the graph. If the edge contains a vertex which is not yet
     * part of the graph
    ...
    /**
     * Adds a given vertex to the graph. The vertex is initialized with an empty
     * adjacencyListProperty
    ...
    public void addVertex(Vertex vertex) {
        ...
        adjacentSetProperty.addListener(new ChangeListener<ObservableSet<Edge>>() {
            /*
             * if an adjacencyList is changed the map representing the graph should also
             * recognize a change.
             * To reach that goal we shortly change the list to null and then set it with
             * the new value.
             * Then the graph will listen to changes to the lists as well.
             */
            @Override
            public void changed(ObservableValue<? extends ObservableSet<Edge>> observable, ObservableSet<Edge> oldValue,
                    ObservableSet<Edge> newValue) {
    ...
    /**
     * Removes the given vertex from the graph. Additionally also deletes every
     * depending on edge.
     * 
    ...
    /**
     * takes the graph and converts it to a csv file. This file is saved in the
     * output directory
